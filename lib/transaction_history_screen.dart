...
String getCurrencySymbol(String currencyCode) {
  ...
  _showTransactionDetails(
    ...
    createdAt: createdAt,
    note: note,
    transactionId: transaction.id, // Menambahkan ID transaksi
  );
},
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        _showCountrySelectionDialog(context, (String selected) {
                          setState(() {
                            selectedCountry = selected;
                            currencyCode = countryToCurrency[selectedCountry] ?? 'USD';
              ...
              ElevatedButton(
                ...
                onPressed: () async {
                  if (_formKey.currentState!.validate()) {
                    double newAmount = double.tryParse(amountController.text) ?? amount;
...
void _showCountrySelectionDialog(BuildContext context, Function(String) onSelected) {
  showDialog(
    context: context,
    builder: (context) {
      return AlertDialog(
