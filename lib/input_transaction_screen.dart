...
class InputTransactionScreen extends StatefulWidget {
  ...
  final Map<String, dynamic>
      exchangeRates; // Menambahkan parameter kurs mata uang
    ...
    if (_formKey.currentState!.validate() &&
      ...
      try {
        ...
        final double? conversionRate =
            widget.exchangeRates[currencyCode]?.toDouble();
        if (conversionRate == null) {
          throw Exception(
              "Currency conversion rate for $currencyCode not found.");
        }
        ...
        final double currentBalance = (userDocSnapshot['balance'] as num)
            .toDouble(); // Pastikan ke double
        ...
        await userDocRef.collection('transactions').add({
          ...
          'createdAt':
              Timestamp.fromDate(_selectedDate!), // Gunakan 'createdAt'
        ...
        await userDocRef
            .update({'balance': FieldValue.increment(-convertedAmount)});
        ...
        showDialog(
          ...
          builder: (context) => AlertDialog(
            ...
            content:
                const Text('Your transaction has been added successfully!'),
            actions: [
              TextButton(
                onPressed: () {
        ...
        if (e.toString().contains('Currency code')) {
          ...
          errorMessage =
              "Currency conversion rate for $selectedCountry not available.";
              ...
              Expanded(
                child: Container(
                  padding: const EdgeInsets.fromLTRB(
                      16, 40, 16, 16), // Padding dalam rectangle
                  decoration: BoxDecoration(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                color: const Color.fromARGB(
                                    255, 125, 175, 216), // Border hex #4383B7
                                width: 1.5,
                              ),
                            ),
                                ...
                                if (selectedCategory != null)
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: categoriesWithIcons.firstWhere(
                                              (category) =>
                                                  category['name'] ==
